            ...
            <div className="mt-10">
              ...
              <div className="mt-6 sm:max-w-xl">
                ...
                <p className="mt-6 text-xl text-gray-500">
                  Empowering employees to lead healthier, happier lives through data-driven wellness challenges and activity tracking.
                </p>
              </div>
              <div className="mt-6 sm:max-w-xl">
                <ul className="list-disc ml-6 text-gray-600">
                  <li>
                    <span className="font-bold">Activity Tracking</span> seamlessly log walks, runs, yoga, and cycling with real-time data integration.
                  </li>
                  <li>
                    <span className="font-bold">Wellness Challenges</span> join company-wide challenges, compete with colleagues, and earn points for meeting healthy targets.
                  </li>
                  <li>
                    <span className="font-bold">Personalized Dashboards</span> visualize your health progress with intuitive charts powered by FastAPI and MongoDB.
                  </li>
                  <li>
                    <span className="font-bold">Secure Authentication</span> enterprise-grade JWT and Magic Link login to keep your health data private and secure.
                  </li>
                  <li>
                    <span className="font-bold">Real-time Analytics</span> built with a modern FARM stack for high-performance and scalable health monitoring.
                  </li>
                </ul>
              </div>
            </div>
